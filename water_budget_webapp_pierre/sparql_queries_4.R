...
file <- rdf_parse("graphDB.ttl", format="turtle")
...
# df_subcomponent_v2.csv right now has components without flow info and D3 works with that
...
write_csv(df, "www/df_subcomponent_v2.csv")
...
write(df_subcomponentJSON, "www/df_subcomponent_v2.json")
...
# but with flow information d3 doesnt work...
# so change the file name below so i can go back and forth between flow info/no flow info
write_csv(df, "www/df_partial_subcomponent_v2.csv")
...
write(df_partial_subcomponentJSON, "www/df_partial_subcomponent_v2.json")
